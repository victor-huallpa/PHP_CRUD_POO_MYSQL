...
<?php 
    ...
    $datos = $insLogin->seleccionarDatos("Unico","usuarios","usuario_id", $id);
...
?>
    ...
    <p class="has-text-centered pb-6"><?php echo "<strong>Usuario creado:</strong> ".date("d-m-Y h:m:s A", strtotime($datos['usuario_creado']))." &nbsp; <strong>Usuario actualizado: </strong>".date("d-m-Y h:m:s A", strtotime($datos['usuario_actualizado']))?> </p>

	<div class="columns">
		<div class="column is-two-fifths">
            <?php if(is_file('./app/views/resources/photos/'.$datos['usuario_foto'])){ ?>
			<figure class="image mb-6">
                <img class="is-rounded" src="<?php echo APP_URL; ?>app/views/resources/photos/<?php echo $datos['usuario_foto']; ?>">
			</figure>
