<?php
	...
	class userController extends mainModel{
		...
		public function registrarUsuarioControlador(){
    		...
    		$img_dir="../views/resources/photos/";
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
							...
							<td>
			                    <a href="'.APP_URL.'userFoto/'.$rows['usuario_id'].'/" class="button is-info is-rounded is-small">Foto</a>
			                </td>
			                <td>
		...
		public function actualizarUsuarioControlador(){
		    ...
		    $check_admin=$this->ejecutarConsulta("SELECT * FROM usuarios WHERE usuario_usuario='$admin_usuario' AND usuario_id='".$_SESSION['id']."'");
		...
		public function eliminarFotoUsuarioControlador(){
		    ...
		    if($datos->rowCount()<=0){
		        $alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
					"texto"=>"No hemos encontrado el usuario en el ",
					"icono"=>"error"
				];
				return json_encode($alerta);
		        exit();
